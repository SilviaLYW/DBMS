...
<div class="super_container">
	...
	<div style="text-align:center;width:700px;margin:0px auto; top:150px; margin-bottom:200px; overflow:auto; font-family:Microsoft JhengHei; ">
			...
			<button class="btn btn-mini"  type="submit"  name="product" onclick="location.href='products.php'">繼續購物</button>
			<button class="btn btn-mini"  type="submit"  name="buy" onclick="location.href='buy.php'">查看清單</button>
	</div>
